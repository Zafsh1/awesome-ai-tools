// Share modal — zero-backend sharing.
// "Share" generates a polished standalone HTML page of the collection
// (downloadable, sendable to anyone) and copies a markdown link list
// to the clipboard. No servers, no accounts, no Firebase.
...
async function handleShare() {
  ...
  // Show the copy-markdown affordance
  const input = document.getElementById('share-link-input');
  input.value = `${name} — ${_currentEntries.length} bookmarks (HTML downloaded)`;
